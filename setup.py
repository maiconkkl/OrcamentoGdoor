...
setup(
    name='Orcamento',
    version='',
    packages=['venv.Lib.site-packages.fdb', 'venv.Lib.site-packages.empty', 'venv.Lib.site-packages.django',
              ...
              'venv.Lib.site-packages.django.templatetags', 'venv.Lib.site-packages.firebird',
              'venv.Lib.site-packages.rest_framework', 'venv.Lib.site-packages.rest_framework.utils',
              'venv.Lib.site-packages.rest_framework.schemas', 'venv.Lib.site-packages.rest_framework.authtoken',
              ...
              'venv.Lib.site-packages.pip-9.0.1-py3.6.egg.pip.operations', 'Orcamento', 'Orcamento.core',
              'Orcamento.core.migrations'],
    url='',
    license='',
    author='Maiconkkl',
    author_email='',
